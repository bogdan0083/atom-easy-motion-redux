...
const activate = () => {
  ...
  disposables.add(
    atom.commands.add('atom-text-editor:not([mini])', {
      ...
      'easymotion-plus:words-starting': () => {
        easyMotion.activate({ mode: 'words-starting' })
      },
      ...
      'easymotion-plus:words-starting-select': () => {
        easyMotion.activate({ mode: 'words-starting', select: true })
      }
    })
  );
};
